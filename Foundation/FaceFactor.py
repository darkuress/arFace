...
class FaceFactor(Core.Core, Util.Util):
    ...
    def __lidFactor(self):
        ...
        cmds.addAttr(self.lidFactor, longName= 'browRotateX_scale', attributeType='float', dv = 20) 
        cmds.addAttr(self.lidFactor, longName= 'browRotateY_scale', attributeType='float', dv = 20) 
